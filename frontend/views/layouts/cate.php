...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        $rows = \backend\models\GoodsCategory::findOne(['id'=>$_GET['id']]);
                    ...
                    <div class="child">
                        ...
                        <ul>
                            <?php foreach($sons as $son):?>
                                <li><a href="/index/goods?id=<?=$son->id?>"><?=$son->name?></a></li>
                            <?php endforeach;?>
                        </ul>
                    </div>
                <?php endforeach;?>
    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                <?php $goodss=\backend\models\Goods::find()->where(['goods_category_id'=>$_GET['id']])->all();
                ?>
                <?php foreach($goodss as $good):?>
                    <li>
                        <dl>
                            <dt><a href="/index/goods.html?id=<?=$good->id?>"><img src="<?='http://admin.yii2shop.com'.$good->logo?>" alt="" /></a></dt>
