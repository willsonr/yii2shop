        ...
        <div class="topnav_right fr">
            <ul>
                <li><?php if(!Yii::$app->user->isGuest){
                        echo Yii::$app->user->identity->username.",欢迎来到东京商城!&nbsp;|&nbsp;".Html::a('注销',['member/logout']) ;
                    }else{
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_left fl">
        <!-- 相关分类 start -->
        <?php  $id=$_GET['id'];
        $row = \backend\models\Goods::findOne(['id'=>$id])->goods_category_id;
        $row = \backend\models\GoodsCategory::findOne(['id'=>$row])->parent_id;
        $rows = \backend\models\GoodsCategory::find()->where(['parent_id'=>$row])->all();
        ?>
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <?php $sig = \backend\models\Goods::findOne(['id'=>$id])?>
        <div class="summary">
            <h3><strong><?=$sig->name?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?='http://admin.yii2shop.com'.$sig->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?='http://admin.yii2shop.com'.$sig->logo?>" alt="" width="350px" height="350px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <?php $gals = \backend\models\GoodsGallery::find()->where(['goods_id'=>$sig->id])->all();?>
                        <ul>
                                ...
                                <li>
                                    <a href="javascript:void(0);"
                                       rel="{gallery: 'gal1', smallimage: '<?=Yii::getAlias('@web')?>/images/preview_m3.jpg',largeimage: '<?=Yii::getAlias('@web')?>/images/preview_l3.jpg'}">
                                        <img src="<?='http://admin.yii2shop.com'.$gal->path?>"/>
                                </li>
                            <?php endforeach;?>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$sig->sn?></li>
                    <li class="market_price"><span>定价：</span><em><?=$sig->market_price?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong><?=$sig->shop_price?></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=date('Y-m-d',$sig->create_time)?></li>
                        ...
                        <li>
                            <dl>
                                ...
                                <dd>
                                    ...
                                    <input type="hidden" name="goods_id" value="<?=$sig->id?>">
                                </dd>
                            </dl>
                        </li>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li>
                                <?php $intro = \backend\models\GoodsIntro::findOne(['goods_id'=>$id])->content?>
                                <?=$intro?>
                            </li>
